...
- [UAA CVE for Session ID](https://www.cloudfoundry.org/blog/cve-2018-1192/)
- UAA 4.9.0 & 4.10.0 Released - Highlights below
  - OpenID Connect Session Management in UAA Singular
  - UAA Google Authenticator Support
  - Manage Identity Providers via API for UAA Default Zone
  - Custom URL Formats for Mobile Apps

- UAA 4.11.0 in progress
  - UAA support for OIDC to Kubenetes (kubectl). Send email_verified claim
  - Password Grant support for MFA
  - PR Merges
