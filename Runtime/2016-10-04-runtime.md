...
- Team has been working on addressing issues with scaling traffic controllers increasing load on Dopplers.  Work centered around redcuing number of connections needed per Doppler/Traffic Controller and increasing throughput to help take load off Dopplers. Expecting to have production load testing on this work Oct 17.
- Efforts to prepare for removal of deprecated loggregator end point.  Coordinated removal of route, and removal of endpoint in CAPI (v2/info).  
- We inadvertently included the removal of the route registrar for the loggregator end point in CF 244.  Working on communications to inform of options. 
